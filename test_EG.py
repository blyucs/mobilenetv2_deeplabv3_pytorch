...
net = deeplab_v3_plus.DeepLabv_v3_plus_mv2_os_32(nInputChannels=3, n_classes=2)
...
# finetuning
# if args.finetuning:
net = save.load_model(net, "result/deeplab_v3_plus/modelEG1800.pt")
...
class NewCrop(object):
    ...
    def __call__(self, image,mask):
        ...
        self.crop_size[0] = 576#224 #352
        self.crop_size[1] = 576#224 #352
